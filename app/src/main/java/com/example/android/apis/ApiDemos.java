...
public class ApiDemos extends ListActivity {
    ...
    public static final String CATEGORY_SAMPLE_CODE_ONE = "android.intent.category.SAMPLE_CODE_ONE";
    public static final String CATEGORY_SAMPLE_CODE_TWO = "android.intent.category.SAMPLE_CODE_TWO";
    public static final String CATEGORY_SAMPLE_CODE_THREE = "android.intent.category.SAMPLE_CODE_THREE";
